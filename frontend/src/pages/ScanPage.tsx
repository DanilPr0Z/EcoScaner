        ...
        <>
          ...
          {result && category && (
            <>
              ...
              {/*
                Исправление показываем всем, а не только в разработке. Это
                единственный способ, которым модель узнаёт о своих ошибках:
                снимок и поправка сохраняются и идут в дообучение. Пока кнопка
                была спрятана, пользователь видел неверный ответ и не мог
                ничего с этим сделать, а мы теряли ровно те случаи, на которых
                модель и надо учить. Технический блок ниже остаётся скрытым —
                он объясняет ответ, но не влияет на него.
              */}
